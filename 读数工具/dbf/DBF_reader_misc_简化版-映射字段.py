...
# 插入数据库总耗时： 2.292591094970703 记录数: 42286
# df.to_sql('dbf_table', engine, if_exists='append', index=False,chunksize=1000)
...
# 插入数据库总耗时： 0.41179990768432617 记录数: 42286
# targetDF.to_sql('dbf_2_mysql_table', engine, if_exists='append', index=False,chunksize=1000)
targetDF.to_sql('dbf_2_oracle_table', engine, if_exists='append', index=False,chunksize=1000)
